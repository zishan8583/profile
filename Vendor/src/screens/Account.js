import { ActivityIndicator, StyleSheet, Text, View,ScrollView, Pressable, TouchableOpacity } from 'react-native'
...
const authCtx = useContext(AuthContext)
  ...
  return (
     ...
     <View style={styles.container}>
        ...
        {/* </View> */}
        <TouchableOpacity onPress={()=>authCtx.logout()}  style={{paddingVertical: 20,alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#ccc' ,width: '100%'}}>
